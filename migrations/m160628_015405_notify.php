...
class m160628_015405_notify extends \cmsgears\core\common\base\Migration {
	...
	private function upEvent() {
		...
		$this->createTable( $this->prefix . 'notify_event', [
			...
			'preReminderCount' => $this->smallInteger( 6 )->notNull()->defaultValue( 0 ),
			'preReminderInterval' => $this->smallInteger( 6 )->notNull()->defaultValue( 0 ),
			'preIntervalUnit' => $this->smallInteger( 6 )->notNull()->defaultValue( 2 ),
			'preTriggerCount' => $this->smallInteger( 6 )->notNull()->defaultValue( 0 ),
			'postReminderCount' => $this->smallInteger( 6 )->notNull()->defaultValue( 0 ),
			'postReminderInterval' => $this->smallInteger( 6 )->notNull()->defaultValue( 0 ),
			'postIntervalUnit' => $this->smallInteger( 6 )->notNull()->defaultValue( 2 ),
			'postTriggerCount' => $this->smallInteger( 6 )->notNull()->defaultValue( 0 ),
