...
$this->title 	= 'Delete Event | ' . $coreProperties->getSiteTitle();
			...
			<div class="box-content-wrap frm-split-40-60">
				<div class="box-content">
					...
					<div class="row">
						...
						<div class="col col3">
							<?= $form->field( $model, 'preReminderInterval' )->textInput( [ 'readonly'=> 'true' ] ) ?>
						</div>
						<div class="col col3">
					...
					<div class="row">
						...
						<div class="col col3">
							<?= $form->field( $model, 'postReminderInterval' )->textInput( [ 'readonly'=> 'true' ] ) ?>
						</div>
						<div class="col col3">
