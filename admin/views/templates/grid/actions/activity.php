<span cmt-app="notification" cmt-controller="notification" cmt-action="toggleRead" action="notify/activity/toggle-read?id=<?= $model->id ?>">
...
<?php if( $model->isTrash() ) { ?>
	<span cmt-app="notification" cmt-controller="notification" cmt-action="delete" action="notify/activity/delete?id=<?= $model->id ?>">
		<div class="spinner max-area-cover">
...
<?php } else { ?>
	<span cmt-app="notification" cmt-controller="notification" cmt-action="trash" action="notify/activity/trash?id=<?= $model->id ?>">
		<div class="spinner max-area-cover">
			<div class="valign-center cmti cmti-spinner-1 spin"></div>
		</div>
